...
final noteList = <Note>[
  Note("What is Flutter?", "Flutter is an open-source UI framework for creating native mobile applications. It allows developers to build mobile applications a single codebase."),
  Note("Stateful Widgets", "The widgets whose state can be altered once they are built are called stateful Widgets."),
  Note("Conditional (ternary) operator", "The conditional (ternary) operator in Dart takes three operands: a condition, first expression (if truthy) and second expression (if falsy).")
];
